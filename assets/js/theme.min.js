    ...
    var e = {
        ...
        masonryGrid: function() {
            ...
            {for (let e = function(e) {
                    ...
                    const r = o[e].closest('.cs-masonry-filterable');
                    if (null === r) {return {
                        v: void 0,
                    };}
                    for (let t = r.querySelectorAll('.cs-masonry-filters [data-group]'), a = 0; a < t.length; a++) {t[a].addEventListener('click', function(e) {
                        const t = r.querySelector('.cs-masonry-filters .active'),
        ...
        stickyNavbar: function() {
            const t = document.querySelector('.navbar-sticky');
            if (null != t) {
                const e = t.classList,
                    a = t.offsetHeight;
        ...
        navbarSearch: function() {
            const e = document.querySelectorAll('[data-toggle="search"]'),
        ...
        passwordVisibilityToggle: function() {
            for (var a = document.querySelectorAll('.cs-password-toggle'), e = function(e) {
                    const t = a[e].querySelector('.form-control');
        ...
        fileDropArea: function() {
            for (var t = document.querySelectorAll('.cs-file-drop-area'), e = function(e) {
                    const n = t[e].querySelector('.cs-file-drop-input'),
        ...
        labelUpdate: function() {
            for (let e = document.querySelectorAll('[data-label]'), t = 0; t < e.length; t++) {e[t].addEventListener('change', function() {
                const e = this.dataset.label;
                try {
        ...
        radioTabs: function() {
            for (let e = document.querySelectorAll('[data-toggle="radioTab"]'), t = 0; t < e.length; t++) {e[t].addEventListener('click', function() {
        ...
        offcanvas: function() {
            for (let e = document.querySelectorAll('[data-toggle="offcanvas"]'), t = 0; t < e.length; t++) {e[t].addEventListener('click', function(e) {
        ...
        scrollTopButton: function() {
            const t = document.querySelector('.btn-scroll-top');
            if (null != t) {
                const a = parseInt(600, 10);
                window.addEventListener('scroll', function(e) {
        ...
        carousel: function() {
            ! function(e, t, a) {
                for (let r = 0; r < e.length; r++) {t.call(a, r, e[r]);}
                ...
                const n = _objectSpread(_objectSpread({}, r), a),
                    o = tns(n),
                ...
                const u = s.querySelector('.cs-carousel-label');
        ...
        productGallery: function() {
            const o = document.querySelectorAll('.cs-product-gallery');
            if (o.length)
            {for (let e = function(a) {
                    ...
                    function t(e) {
                        e.preventDefault();
                        for (let t = 0; t < r.length; t++) {n[t].classList.remove('active'), r[t].classList.remove('active');}
        ...
        videoPopupBtn: function() {
            const e = document.querySelectorAll('.cs-video-btn');
            if (e.length)
            {for (let t = 0; t < e.length; t++) {lightGallery(e[t], {
                selector: 'this',
                download: !1,
        ...
        countdown: function() {
            const t = document.querySelectorAll('.cs-countdown');
            if (null != t)
            {for (let e = function(e) {
                    let a = t[e].dataset.countdown,
        ...
        charts: function() {
            ...
            const e = document.querySelectorAll('[data-line-chart]'),
                t = document.querySelectorAll('[data-bar-chart]'),
                s = document.querySelectorAll('[data-pie-chart]');
            if (0 !== e.length || 0 !== t.length || 0 !== s.length) {
                let c, a = document.head || document.getElementsByTagName('head')[0],
                    l = document.createElement('style');
                a.appendChild(l);
                for (let r = 0; r < e.length; r++) {
                    let n = JSON.parse(e[r].dataset.lineChart),
        ...
        priceSwitch: function() {
            const o = document.querySelectorAll('.cs-pricing-wrap');
            if (null !== o)
            {for (let e = function(e) {
                    function t() {
                        if (r.checked) {
                            a.parentNode.classList.add('cs-price-switch-on');
                            for (let e = 0; e < n.length; e++) {n[e].innerHTML = n[e].dataset.newPrice;}
                        } else {
                            a.parentNode.classList.remove('cs-price-switch-on');
                            for (let t = 0; t < n.length; t++) {n[t].innerHTML = n[t].dataset.currentPrice;}
                        }
                    }
        ...
        rangeSlider: function() {
            for (var o = document.querySelectorAll('.cs-range-slider'), e = function(e) {
                    const t = o[e].querySelector('.cs-range-slider-ui'),
        ...
        ajaxifySubscribeForm: function() {
            const s = document.querySelectorAll('.cs-subscribe-form');
            if (null !== s) {
                for (let e = function(e) {
                        const t = s[e].querySelector('button[type="submit"]'),
                            a = t.innerHTML,
        ...
        viewSwitcher: function() {
            const e = document.querySelectorAll('[data-view]');
            if (0 < e.length)
            {for (let t = 0; t < e.length; t++) {e[t].addEventListener('click', function(e) {
                const t = this.dataset.view;
        ...
        datePicker: function() {
            const e = document.querySelectorAll('.cs-date-picker');
            if (0 !== e.length)
            {for (let t = 0; t < e.length; t++) {
                let a = void 0;
                null != e[t].dataset.datepickerOptions && (a = JSON.parse(e[t].dataset.datepickerOptions));
                const r = e[t].classList.contains('cs-date-range') ? {
        ...
        checkboxToggleClass: function() {
            const e = document.querySelectorAll('[data-checkbox-toggle-class]');
            if (0 !== e.length)
            {for (let t = 0; t < e.length; t++) {e[t].addEventListener('change', function() {
                const e = document.querySelector(this.dataset.target),
                    t = this.dataset.checkboxToggleClass;
                this.checked ? e.classList.add(t) : e.classList.remove(t);
            });}}
        },
        masterCheckbox: function() {
            const e = document.querySelectorAll('[data-master-checkbox-for]');
            if (0 !== e.length)
            {for (let t = 0; t < e.length; t++) {e[t].addEventListener('change', function() {
                const e = document.querySelector(this.dataset.masterCheckboxFor).querySelectorAll('input[type="checkbox"]');
                if (this.checked)
                {for (let t = 0; t < e.length; t++) {e[t].checked = !0, e[t].dataset.checkboxToggleClass && document.querySelector(e[t].dataset.target).classList.add(e[t].dataset.checkboxToggleClass);}}
                else
                {for (let a = 0; a < e.length; a++) {e[a].checked = !1, e[a].dataset.checkboxToggleClass && document.querySelector(e[a].dataset.target).classList.remove(e[a].dataset.checkboxToggleClass);}}
            });}}
        },
        parallax: function() {
            for (let e = document.querySelectorAll('.cs-parallax'), t = 0; t < e.length; t++) {new Parallax(e[t]);}
        },
    };
    e.init();
}(jQuery);