-- ============================================================================
-- Quick fix: Update sp_ProcessParseQueue cleanup retention to 24 hours
-- Run this entire script in SSMS (Execute or F5)
-- ============================================================================
...
BEGIN
    ...
    PRINT 'Dropped existing sp_ProcessParseQueue';
END
GO
...
PRINT 'Updated sp_ProcessParseQueue with 24-hour retention for completed entries';
GO
