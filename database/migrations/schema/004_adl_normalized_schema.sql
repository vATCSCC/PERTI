...
-- /adl/migrations/ directory.
-- 
-- Run Order:
--   1. 001_adl_core_tables.sql
--   2. 002_adl_times_trajectory.sql
--   3. 003_adl_waypoints_stepclimbs.sql
--   4. 004_adl_reference_tables.sql
--   5. 005_adl_views_seed_data.sql
...
PRINT 'Execute the scripts from the /adl/migrations/ directory in order:';
PRINT '';
PRINT '  1. /adl/migrations/001_adl_core_tables.sql';
PRINT '  2. /adl/migrations/002_adl_times_trajectory.sql';
PRINT '  3. /adl/migrations/003_adl_waypoints_stepclimbs.sql';
PRINT '  4. /adl/migrations/004_adl_reference_tables.sql';
PRINT '  5. /adl/migrations/005_adl_views_seed_data.sql';
PRINT '';
