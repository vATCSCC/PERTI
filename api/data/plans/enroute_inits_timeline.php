<?php
/**
 * En Route Initiative Timeline API
 */
...
switch ($method) {
    case 'GET':
        ...
        $sql = "SELECT * FROM p_enroute_init_timeline WHERE p_id = ? ORDER BY start_datetime ASC";
    ...
    case 'POST':
        ...
        $sql = "INSERT INTO p_enroute_init_timeline 
    ...
    case 'PUT':
        ...
        $sql = "UPDATE p_enroute_init_timeline SET 
    ...
    case 'DELETE':
        ...
        $stmt = $conn_sqli->prepare("DELETE FROM p_enroute_init_timeline WHERE id = ?");
