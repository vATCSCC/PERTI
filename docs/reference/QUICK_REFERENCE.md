...
> **SYSTEM STATUS: HIBERNATING** (re-entered 2026-03-29). Only ADL ingest daemon running. Azure resources downscaled. See `docs/operations/HIBERNATION_RUNBOOK.md` for hibernation procedures.
