...
// Check APCu cache before opening DB connection (15s TTL - rates change with ATIS/config)
$cacheKey = demand_cache_key('rates', ['airport' => $airport]);
...
// Cache response (15s TTL)
apcu_cache_set($cacheKey, $response, 15);
header('X-Cache: MISS');
