...
try {
    ...
    $sql = "INSERT INTO p_terminal_staffing (facility_name, staffing_status, staffing_quantity, comments, p_id) VALUES (?, ?, ?, ?, ?)";
    ...
    $conn_pdo->rollback();
    error_log("terminal_staffing/post error: " . $e->getMessage());
