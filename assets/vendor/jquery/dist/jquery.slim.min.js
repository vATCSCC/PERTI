/*! jQuery v3.5.1 -ajax,-ajax/jsonp,-ajax/load,-ajax/script,-ajax/var/location,-ajax/var/nonce,-ajax/var/rquery,-ajax/xhr,-manipulation/_evalUrl,-deprecated/ajax-event-alias,-effects,-effects/Tween,-effects/animatedSelector | (c) JS Foundation and other contributors | jquery.org/license */ ! function(e, t) {
    ...
    function C(e, t, n) {
        let r, i, o = (n = n || w).createElement('script');
        if (o.text = e, t)
    ...
    const f = '3.5.1 -ajax,-ajax/jsonp,-ajax/load,-ajax/script,-ajax/var/location,-ajax/var/nonce,-ajax/var/rquery,-ajax/xhr,-manipulation/_evalUrl,-deprecated/ajax-event-alias,-effects,-effects/Tween,-effects/animatedSelector',
        E = function(e, t) {
    ...
    const p = function(n) {
        let e, p, x, o, i, h, f, g, w, u, l, C, T, a, E, v, s, c, y, A = 'sizzle' + 1 * new Date,
            d = n.document,
            N = 0,
            r = 0,
            m = ue(),
        ...
        for (e in p = se.support = {}, i = se.isXML = function(e) {
            ...
            let t, n, r = e ? e.ownerDocument || e : d;
            ...
            let n = x.attrHandle[t.toLowerCase()],
            ...
            filter: {
                ...
                CHILD: function(h, e, t, g, v) {
                    ...
                    return 1 === g && 0 === v ? function(e) {
                        ...
                        let r, i, o, a, s, u, l = y !== m ? 'nextSibling' : 'previousSibling',
                            c = e.parentNode,
                ...
                PSEUDO: function(e, o) {
                    let t, a = x.pseudos[e] || x.setFilters[e.toLowerCase()] || se.error('unsupported pseudo: ' + e);
    ...
    E.event = {
        ...
        add: function(t, e, n, r, i) {
            let o, a, s, u, l, c, f, d, p, h, g, v = Y.get(t);
            if (X(t)) {
        ...
        remove: function(e, t, n, r, i) {
            let o, a, s, u, l, c, f, d, p, h, g, v = Y.hasData(e) && Y.get(e);
            if (v && (u = v.events)) {
    ...
    E.param = function(e, t) {
        ...
        setOffset: function(e, t, n) {
            let r, i, o, a, s, u, l = E.css(e, 'position'),
                c = E(e),
                f = {};
