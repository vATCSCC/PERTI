...
(function() {
    ...
    function initClocks() {
        const update = () => {
            ...
            if (el('jatoc_clock_hi')) el('jatoc_clock_hi').textContent = fmt('Pacific/Honolulu');
            if (el('jatoc_clock_ak')) el('jatoc_clock_ak').textContent = fmt('America/Anchorage');
            if (el('jatoc_clock_pac')) el('jatoc_clock_pac').textContent = fmt('America/Los_Angeles');
            if (el('jatoc_clock_mtn')) el('jatoc_clock_mtn').textContent = fmt('America/Denver');
            if (el('jatoc_clock_cent')) el('jatoc_clock_cent').textContent = fmt('America/Chicago');
            if (el('jatoc_clock_east')) el('jatoc_clock_east').textContent = fmt('America/New_York');
            if (el('jatoc_clock_atl')) el('jatoc_clock_atl').textContent = fmt('America/Halifax');
            if (el('jatoc_clock_nfl')) el('jatoc_clock_nfl').textContent = fmt('America/St_Johns');
        };
        update();
