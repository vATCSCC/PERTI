...
function processSimTrafficFlight($conn, $record, $source) {
    ...
    // === ARRIVAL TIMES (FIXM columns only) ===

    // eta -> estimated_time_of_arrival, estimated_runway_arrival_time
    ...
    // on_time -> actual_landing_time/actual_in_block_time (ALDT/AIBT)
