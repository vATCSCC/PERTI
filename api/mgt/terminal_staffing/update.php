...
$query = $conn_sqli->query("UPDATE p_terminal_staffing SET facility_name='$facility_name', staffing_status='$staffing_status', staffing_quantity='$staffing_quantity', comments='$comments' WHERE id=$id");
