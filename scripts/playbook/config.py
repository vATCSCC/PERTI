...
# Includes 2001-era legacy headers: FACILITY (=ORIGIN), CORE ROUTING, etc.
ORIGIN_HEADERS = ['ORIGIN', 'ORIGINS', 'ORIG', 'FROM', 'FACILITY']
DEST_HEADERS = ['DEST', 'DESTINATION', 'DESTINATIONS', 'TO']
ROUTE_HEADERS = [
    'ROUTE', 'ROUTES', 'ROUTE STRING', 'ROUTING',
    'CORE ROUTING', 'ROUTING FROM EXIT POINT',
    'PREF ROUTING FROM EXIT POINT', 'PREF ROUTING',
]
