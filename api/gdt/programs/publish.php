...
$advisory_text = generate_actual_advisory($program, $advisory_number, $conn_adl);

// Write advisory record to tmi_advisories
$program_type = $program['program_type'] ?? 'GS';
$adv_type = strpos($program_type, 'GDP') !== false ? 'GDP' : 'GS';
write_advisory_record($conn_tmi, $program, $advisory_number, $adv_type, $advisory_text, $user_cid, $user_name);
...
// generate_actual_advisory() is now in common.php
