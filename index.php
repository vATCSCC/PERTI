        ...
        <center>
            ...
            <table class="table table-sm table-striped table-bordered w-100">
                <thead class="table-dark text-light">
                    <th><?= __('home.table.eventName') ?></th>
                    <th class="text-center"><?= __('home.table.startDate') ?></th>
                    <th class="text-center"><?= __('home.table.startTime') ?></th>
                    <th class="text-center"><?= __('home.table.endDate') ?></th>
                    <th class="text-center"><?= __('home.table.endTime') ?></th>
                    <th class="text-center"><?= __('home.table.tmuOpLevel') ?></th>
                    <th class="text-center"><?= __('home.table.lastUpdated') ?></th>
                    <th></th>
                </thead>
