        ...
        echo '<tr>';
            ...
            if ($perm == true) {
                echo '<td style="width: 10%;"><center>';
                    ...
                    echo ' ';
                    echo '<a href="javascript:void(0)" onclick="deleteEnrouteStaffing('.$data['id'].')" data-toggle="tooltip" title="Delete Staffing"><span class="badge badge-danger"><i class="fas fa-times"></i> Delete</span></a>';
                echo '</center></td>';
            }
