...
! function(t, e) {
    ...
    'use strict';
    const t = 'undefined' !== typeof globalThis ? globalThis : 'undefined' !== typeof window ? window : 'undefined' !== typeof global ? global : 'undefined' !== typeof self ? self : {};
    ...
    let r, n, i, o = 'object',
        ...
        C = e((function(t) {
            const e = a['__core-js_shared__'] || z('__core-js_shared__', {});
    ...
    var K = {
        ...
        yt = function(t, e) {
            for (let r = gt(e), n = R.f, i = M.f, o = 0; o < r.length; o++) {
                const s = r[o];
                O(t, s) || n(t, s, i(e, s));
            }
        },
    ...
    const Yt = !('undefined' === typeof window || !window.document || !window.document.createElement),
        Gt = zt('species'),
        Ut = Pt.filter;
    At({
        target: 'Array',
    ...
    q[Zt] = !0;
    const ne = zt('unscopables'),
        ie = Array.prototype;
    null == ie[ne] && W(ie, ne, re(null));
    let oe, se, ae, ce = function(t) {
            ie[ne][t] = !0;
        },
        le = {},
        ue = !c((function() {
    ...
    const We = zt('toStringTag'),
        ...
        Ne = {};
    Ne[zt('toStringTag')] = 'z';
    const Ie = '[object z]' !== String(Ne) ? function() {
    ...
    let Ze = function(t, e, r) {
            for (const n in e) {J(t, n, e[n], r);}
            return t;
        },
        tr = !c((function() {
        ...
        sr = e((function(t) {
            ...
            (t.exports = function(t, r, n, i, o) {
                let s, a, c, l, u, f, h, d = Lt(r, n, i ? 2 : 1);
                if (o) {s = t;}
                else {
    ...
    xr.prototype = {
        ...
        delete: function(t) {
            const e = yr(this.entries, (function(e) {
                return e[0] === t;
            }));
    ...
    const wn = Array.prototype,
        ...
        An = function() {
            const t = /[^.]+$/.exec(Sn && Sn.keys && Sn.keys.IE_PROTO || '');
        ...
        qn = function() {
            ...
            return function() {
                ...
                return Object.defineProperty(e.prototype, 'size', {
                    ...
                    void 0 === e && (e = null);
                    for (let r = 0, n = this.__entries__; r < n.length; r++) {
                        const i = n[r];
                        t.call(e, i[1], i[0]);
                    }
                }, e;
    ...
    const Un = 20,
        ...
        Jn = function() {
            ...
            return t.prototype.addObserver = function(t) {
                ...
                const t = this.observers_.filter((function(t) {
    ...
    function ii(t) {
        ...
        if ('border-box' === n.boxSizing && (Math.round(a + o) !== e && (a -= ni(n, 'left', 'right') + o), Math.round(c + s) !== r && (c -= ni(n, 'top', 'bottom') + s)), ! function(t) {
            ...
            const l = Math.round(a + o) - e,
                u = Math.round(c + s) - r;
            1 !== Math.abs(l) && (a -= l), 1 !== Math.abs(u) && (c -= u);
        }
        return ai(i.left, i.top, a, c);
    }
    const oi = 'undefined' !== typeof SVGGraphicsElement ? function(t) {
    ...
    const ci = function() {
        ...
        li = function(t, e) {
            let r, n, i, o, s, a, c, l = (n = (r = e).x, i = r.y, o = r.width, s = r.height, a = 'undefined' !== typeof DOMRectReadOnly ? DOMRectReadOnly : Object, c = Object.create(a.prototype), Zn(c, {
                x: n,
                y: i,
                width: o,
                height: s,
    ...
    let di = void 0 !== Xn.ResizeObserver ? Xn.ResizeObserver : hi,
        pi = null,
        vi = null;
    ...
    const Yi = function() {
        function t(e, r) {
            ...
            this.onScroll = function() {
                ...
                let c = (('y' === n.draggedAxis ? e.pageY : e.pageX) - r.rect[n.axis[n.draggedAxis].offsetAttr] - n.axis[n.draggedAxis].dragOffset) / (i - o.size) * (s - a);
        ...
        return e.init = function() {
            ...
            let e, r = this.contentEl[this.axis[t].scrollSizeAttr],
            ...
            if (void 0 === e && (e = 'y'), this.options.clickOnTrack) {
                ...
                let i = this.axis[e].scrollbar.rect[this.axis[e].offsetAttr],
                    ...
                    c = -1 === a ? s - o : s + o;
                ! function t() {
                    let i, o; - 1 === a ? s > c && (s -= r.options.clickOnTrackSpeed, r.contentWrapperEl.scrollTo(((i = {})[r.axis[e].offsetAttr] = s, i)), n.requestAnimationFrame(t)) : s < c && (s += r.options.clickOnTrackSpeed, r.contentWrapperEl.scrollTo(((o = {})[r.axis[e].offsetAttr] = s, o)), n.requestAnimationFrame(t));
                }();
            }
