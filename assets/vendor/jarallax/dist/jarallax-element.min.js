...
! function(n) {
    ...
    r.m = n, r.c = o, r.d = function(t, e, n) {
        ...
        {for (const o in e) {r.d(n, o, function(t) {
            return e[t];
        }.bind(null, o));}}
        return n;
    }, r.n = function(t) {
    ...
    (function(t) {
        const e = 'undefined' !== typeof window ? window : void 0 !== t ? t : 'undefined' !== typeof self ? self : {};
        n.exports = e;
    }).call(this, e(4));
}, function(t, e) {
    function n(t) {
    ...
    function i() {
        let t, e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : r.a.jarallax;
