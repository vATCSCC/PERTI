...
! function(n) {
    ...
    i.m = n, i.c = o, i.d = function(e, t, n) {
        ...
        {for (const o in t) {i.d(n, o, function(e) {
            return t[e];
        }.bind(null, o));}}
        return n;
    }, i.n = function(e) {
    ...
    (function(e) {
        const t = 'undefined' !== typeof window ? window : void 0 !== e ? e : 'undefined' !== typeof self ? self : {};
        n.exports = t;
    }).call(this, t(4));
}, function(e, t) {
    function n(e) {
    ...
    e.exports = o;
        ...
        a.window.jarallax = r.default, a.window.jarallax.noConflict = function() {
            ...
            const o = r.default.apply(a.window, t);
        ...
        let l, h, p = b.window.navigator,
            ...
            m = function() {
                for (let e = 'transform WebkitTransform MozTransform'.split(' '), t = document.createElement('div'), n = 0; n < e.length; n += 1)
            ...
            w = function() {
                ...
                return e = s, (t = [{
                    ...
                    value: function() {
                        ...
                        let t, n = e.$item.getAttribute('data-jarallax-original-styles');
                    ...
                    key: 'onScroll',
                    value: function(e) {
                        let t, n, o, i, a, r, l, s, c, u, p = this,
