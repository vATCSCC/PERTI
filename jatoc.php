...
<section class="d-flex align-items-center position-relative" style="background: #0f172a; min-height: 80px; margin-top: 60px;" data-jarallax data-speed="0.3">
    <div class="container-fluid pt-2 pb-2">
        ...
        <center><h1 style="color: #f1f5f9; text-shadow: 2px 2px 4px rgba(0,0,0,0.5); margin-bottom: 0;">JATOC</h1><h5 class="text-white" style="margin-bottom: 0;"><i class="fas fa-broadcast-tower text-warning"></i> AWO Incident Monitor</h5></center>
    </div>
</section>
...
<div class="container-fluid mt-2 mb-4 px-3" style="background: #0f172a;">
    ...
    <div class="perti-info-bar" style="background: #0f172a;">
        <div class="row d-flex flex-wrap align-items-stretch" style="gap: 6px; margin: 0 -3px; background: #0f172a;">
            <div class="col-auto px-1">
                <div class="card shadow-sm perti-info-card h-100">
                    <div class="card-body d-flex align-items-center py-2 px-3">
                        <div>
                            <div class="perti-info-label">UTC</div>
            ...
            <div class="col-auto px-1">
                <div class="card shadow-sm perti-info-card h-100">
                    <div class="card-body py-2 px-3">
                        <div class="perti-info-label mb-1">US Local</div>
            ...
            <div class="col-auto px-1">
                <div class="card shadow-sm perti-info-card h-100">
                    <div class="card-body py-2 px-3">
                        <div class="perti-info-label mb-1">Active Incidents</div>
                ...
                <div class="card shadow-sm perti-info-card h-100">
                    <div class="card-body d-flex align-items-center py-2 px-3">
                        <span class="user-profile-btn" onclick="JATOC.showUserProfile()" id="userProfileBtn">
                            <i class="fas fa-user"></i> <span id="userDisplayName" class="user-not-set">Set Profile</span>
                        </span>
                    </div>
                </div>
            </div>
    ...
    <div class="classification-banner">SENSITIVE UNCLASSIFIED INFORMATION // FOR SIMULATION USE ONLY</div>
    
    <!-- Header Bar -->
    <div class="jatoc-header-bar" id="jatocHeaderBar">
        <div class="row align-items-center">
            <div class="col-md-4" id="jatocTitleBlock">
                <div class="jatoc-title">JATOC</div>
                <div class="jatoc-subtitle">Joint Air Traffic Operations Command</div>
            </div>
            <div class="col-md-4 text-center">
                <select id="opsLevelSelect" class="ops-level-badge ops-level-1">
                    <option value="1">Ops Level 1 - Steady State</option>
                    <option value="2">Ops Level 2 - Escalated</option>
                    <option value="3">Ops Level 3 - Major Event</option>
                </select>
            </div>
    ...
    <div class="main-row">
        ...
        <div class="left-col">
            <div>
                <div class="section-header green">POTUS <button class="btn btn-sm btn-link text-white float-right py-0 px-1" onclick="JATOC.editDailyOps('POTUS')" style="font-size:0.7rem"><i class="fas fa-edit"></i></button></div>
                <div class="ops-calendar" id="potusCalendar"><div class="text-muted small p-2">Loading...</div></div>
            </div>
            <div>
                <div class="section-header green">SPACE <button class="btn btn-sm btn-link text-white float-right py-0 px-1" onclick="JATOC.editDailyOps('SPACE')" style="font-size:0.7rem"><i class="fas fa-edit"></i></button></div>
                <div class="ops-calendar" id="spaceCalendar"><div class="text-muted small p-2">Loading...</div></div>
            </div>
            <div style="flex:1">
                <div class="section-header green">VATUSA Events</div>
        ...
        <div class="middle-col">
            <div class="section-header"><i class="fas fa-map-marked-alt mr-1"></i>Active Incidents Map</div>
            <div id="jatoc-map-container">
                <div id="jatoc-map"></div>
                <div class="jatoc-map-legend">
                    <div class="jatoc-map-legend-item"><div class="jatoc-map-legend-dot" style="background-color: #dc2626;"></div>ATC Zero</div>
                    <div class="jatoc-map-legend-item"><div class="jatoc-map-legend-dot" style="background-color: #f59e0b;"></div>ATC Alert</div>
                    <div class="jatoc-map-legend-item"><div class="jatoc-map-legend-dot" style="background-color: #3b82f6;"></div>ATC Limited</div>
                    <div class="jatoc-map-legend-item"><div class="jatoc-map-legend-dot" style="background-color: #8b5cf6;"></div>Non-Responsive</div>
        ...
        <div class="right-col">
            <div class="section-header"><i class="fas fa-users mr-1"></i>Personnel On Position</div>
            <div style="background:#1e293b; border-radius: 0 0 4px 4px; flex:1; overflow-y: auto;">
                <table class="table table-sm table-dark mb-0 personnel-table">
                    <thead><tr><th style="width:55px; color:#94a3b8">Elem</th><th style="width:35px; color:#94a3b8">OIs</th><th style="color:#94a3b8">Name</th></tr></thead>
    ...
    <div class="filter-bar">
        <div class="row align-items-end">
            ...
            <div class="col-auto"><button class="btn btn-sm btn-jatoc" onclick="JATOC.applyFilters()" style="height:31px"><i class="fas fa-filter"></i> Filter</button></div>
            <div class="col-auto"><button class="btn btn-sm btn-outline-info" onclick="JATOC.showRetrieveModal()" style="height:31px"><i class="fas fa-search"></i> Retrieve</button></div>
            <div class="col-auto"><button class="btn btn-sm btn-jatoc-success" onclick="JATOC.showCreateModal()" style="height:31px"><i class="fas fa-plus"></i> New</button></div>
        </div>
    </div>
    ...
    <div class="table-responsive" style="background:#1e293b; border-radius: 0 0 4px 4px;">
        <table class="events-table" id="eventsTable">
            <thead><tr>
                ...
                <th style="width:180px; text-align:center; cursor:default">Quick Actions</th>
            </tr></thead>
...
<div class="modal fade modal-jatoc" id="userProfileModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header"><h5 class="modal-title"><i class="fas fa-user mr-2"></i>User Profile</h5><button type="button" class="close text-white" data-dismiss="modal">&times;</button></div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-8">
                        <label class="small text-muted">NAME *</label>
                        <input type="text" id="profileName" class="form-control form-control-dark" placeholder="Full Name" maxlength="100">
                    </div>
                    <div class="col-md-4">
                        <label class="small text-muted">VATSIM CID</label>
                        <input type="text" id="profileCID" class="form-control form-control-dark" placeholder="1234567" maxlength="10">
                    </div>
                </div>
                <div class="row mt-2">
                    <div class="col-md-4">
                        <label class="small text-muted">OIs (2 chars) *</label>
                ...
                <div class="row mt-2" id="facilitySelectRow">
                    <div class="col-12">
                        <label class="small text-muted">SELECT FACILITY</label>
                        <select id="profileFacility" class="form-control form-control-dark">
                            <option value="">Select facility type first...</option>
                        </select>
                    </div>
                </div>
                <!-- Organization identifier input (for VATUSA/VATSIM) -->
                <div class="org-identifier-row" id="orgIdentifierRow">
                    <label class="small text-muted">IDENTIFIER *</label>
                    <input type="text" id="orgIdentifier" class="form-control form-control-dark form-control-sm" placeholder="e.g., VATUSA3, VATGOV1, VATEUD2" maxlength="20" style="text-transform:uppercase">
                    <small class="text-muted">Enter your organization identifier (e.g., VATUSA#, VATGOV#, VATEUD#)</small>
                </div>
                <!-- Local airport input -->
                <div class="local-airport-row" id="localAirportRow">
                    <label class="small text-muted">AIRPORT ICAO *</label>
                    <input type="text" id="localAirportIcao" class="form-control form-control-dark form-control-sm" placeholder="KATL" maxlength="4" style="text-transform:uppercase">
                    <small class="text-muted">Enter the ICAO code of the airport you represent</small>
                </div>
                ...
                <div class="small text-muted">
                    <strong>Preview:</strong> <span id="profilePreview" class="text-info">-</span>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-outline-danger btn-sm mr-auto" onclick="JATOC.clearProfile()">Clear</button>
                <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">Cancel</button>
                <button type="button" class="btn btn-jatoc btn-sm" onclick="JATOC.saveProfile()">Save</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade modal-jatoc" id="incidentModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header"><h5 class="modal-title" id="incidentModalTitle">New Incident</h5><button type="button" class="close text-white" data-dismiss="modal">&times;</button></div>
            <div class="modal-body">
                <form id="incidentForm">
                    ...
                    <div class="mt-2"><label class="small text-muted">REMARKS</label><textarea id="incidentRemarks" class="form-control form-control-dark" rows="2" placeholder="Initial remarks..." style="font-family: 'Courier New', monospace;"></textarea></div>
                </form>
            </div>
            <div class="modal-footer"><button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">Cancel</button><button type="button" class="btn btn-jatoc btn-sm" onclick="JATOC.saveIncident()">Save</button></div>
        </div>
    </div>
</div>
...
<div class="modal fade modal-jatoc" id="incidentDetailsModal" tabindex="-1">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header py-2"><h5 class="modal-title">Incident <span id="detailsIncNum" class="incident-number ml-2">-</span></h5><button type="button" class="close text-white" data-dismiss="modal">&times;</button></div>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="details-grid mb-2">
                            ...
                            <div class="label">Duration</div><div class="value" id="detailsDuration">-</div>
                            <div class="label">Created By</div><div class="value" id="detailsCreatedBy">-</div>
                            <div class="label">Report#</div><div class="value" id="detailsReportNum">-</div>
                        </div>
                        <div class="section-header slate" style="font-size:0.7rem">Remarks</div>
                        <div id="detailsRemarks" class="mb-2">-</div>
                        <div class="section-header slate" style="font-size:0.7rem">Update History</div>
                    ...
                    <div class="col-lg-4">
                        <div class="section-header indigo" style="font-size:0.7rem">Add Update</div>
                        <div class="update-form-section">
                            ...
                            <button class="btn btn-block btn-jatoc btn-sm" onclick="JATOC.addUpdate()">Add Update</button>
                        </div>
                        <div class="section-header ops-change" style="font-size:0.7rem">Change Ops Level</div>
                        <div class="update-form-section">
                            <select id="modalOpsLevel" class="form-control form-control-dark form-control-sm mb-2">
                                <option value="1">Level 1 - Steady State</option>
                                <option value="2">Level 2 - Escalated</option>
                                <option value="3">Level 3 - Major Event</option>
                            </select>
                            <input type="text" id="modalOpsReason" class="form-control form-control-dark form-control-sm mb-2" placeholder="Reason...">
                            <button class="btn btn-block btn-secondary btn-sm" onclick="JATOC.changeOpsLevel()">Change Level</button>
                        </div>
                        <div class="action-buttons mt-2">
                            <button class="btn btn-outline-warning btn-sm" onclick="JATOC.markPaged()"><i class="fas fa-bell"></i> Mark Paged</button>
                            <button class="btn btn-outline-info btn-sm" onclick="JATOC.editFromDetails()"><i class="fas fa-edit"></i> Edit Incident</button>
                            <button class="btn btn-outline-light btn-sm" onclick="JATOC.generateReport()"><i class="fas fa-file-alt"></i> Generate Report#</button>
                            <button class="btn btn-outline-primary btn-sm" onclick="JATOC.viewReport()" id="btnViewReport" style="display:none"><i class="fas fa-file-invoice"></i> View Report</button>
                            <button class="btn btn-outline-success btn-sm" onclick="JATOC.closeoutIncident()" id="btnCloseOut"><i class="fas fa-check"></i> Close Out</button>
                            <button class="btn btn-outline-info btn-sm" onclick="JATOC.reopenIncident()" id="btnReopen" style="display:none"><i class="fas fa-redo"></i> Reopen</button>
                            <button class="btn btn-outline-danger btn-sm" onclick="JATOC.deleteIncident()"><i class="fas fa-trash"></i> Delete</button>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="modal fade modal-jatoc" id="retrieveModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header py-2"><h5 class="modal-title"><i class="fas fa-search mr-2"></i>Retrieve Incident</h5><button type="button" class="close text-white" data-dismiss="modal">&times;</button></div>
            <div class="modal-body py-2">
                <div class="row mb-3">
                    <div class="col-md-4">
                        <label class="small text-muted">INCIDENT #</label>
                        <input type="text" id="retrieveIncNum" class="form-control form-control-dark form-control-sm" placeholder="251230001">
                    </div>
                    <div class="col-md-4">
                        <label class="small text-muted">REPORT #</label>
                        <input type="text" id="retrieveReportNum" class="form-control form-control-dark form-control-sm" placeholder="25-00001">
                    </div>
                    <div class="col-md-4">
                        <label class="small text-muted">FACILITY</label>
                        <input type="text" id="retrieveFacility" class="form-control form-control-dark form-control-sm" placeholder="ZTL">
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <label class="small text-muted">INC TYPE</label>
                        <select id="retrieveIncType" class="form-control form-control-dark form-control-sm">
                            <option value="">All</option>
                            <option value="ATC_ZERO">ATC Zero</option>
                            <option value="ATC_ALERT">ATC Alert</option>
                            <option value="ATC_LIMITED">ATC Limited</option>
                ...
                <div class="row mb-3">
                    <div class="col-12">
                        <button class="btn btn-jatoc btn-sm" onclick="JATOC.searchIncidents()"><i class="fas fa-search"></i> Search</button>
                        <button class="btn btn-outline-secondary btn-sm ml-2" onclick="JATOC.clearRetrieveForm()"><i class="fas fa-times"></i> Clear</button>
                    </div>
                </div>
                <div class="section-header slate" style="font-size:0.7rem">Search Results</div>
                <div id="retrieveResults" style="max-height: 300px; overflow-y: auto; background:#0f172a; border-radius:0 0 4px 4px; padding:6px;">
                    <div class="text-muted text-center py-3">Enter search criteria above</div>
                </div>
            </div>
            <div class="modal-footer py-1"><button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">Close</button></div>
        </div>
