-- ============================================================================
-- ADL Normalized Schema - Migration 004: Reference Data Tables
-- 
-- Part of the ADL Database Redesign
-- Creates reference tables for GIS route parsing
-- 
-- Run Order: 4 of 5
-- ============================================================================
...
PRINT '=== ADL Migration 004: Reference Data Tables ===';
PRINT 'Started at: ' + CONVERT(VARCHAR, GETUTCDATE(), 120);
GO

-- ============================================================================
-- 1. nav_fixes - Navigation Waypoints (~150K records from points.csv)
-- ============================================================================
...
-- ============================================================================
-- 3. airway_segments - Individual Airway Segments with Geometry
-- ============================================================================
...
-- ============================================================================
-- 4. coded_departure_routes - CDR Expansions
-- ============================================================================
...
-- ============================================================================
-- 5. playbook_routes - Playbook Route Expansions
-- ============================================================================
...
-- ============================================================================
-- 6. area_centers - ARTCC/TRACON Pseudo-Fixes
-- ============================================================================
...
-- ============================================================================
-- 7. nav_procedures - DP/STAR Definitions
-- ============================================================================
...
-- ============================================================================
-- 8. oceanic_fir_bounds - Oceanic FIR Bounding Boxes (for tier assignment)
-- ============================================================================
...
PRINT '';
PRINT '=== ADL Migration 004 Complete ===';
