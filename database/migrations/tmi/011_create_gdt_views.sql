-- ============================================================================
-- VATSIM_TMI GDT Views (v2 - Azure SQL Compatible)
-- Views for GDT (Ground Delay Tools) functionality
-- ============================================================================
-- Version: 1.0.1
-- Date: 2026-01-21
-- Author: HP/Claude
--
-- Note: Uses existing column naming conventions (created_at, updated_at)
-- ============================================================================

USE VATSIM_TMI;
GO

PRINT 'Creating GDT views v2...';
PRINT '';
...
PRINT '  Created: vw_tmi_flight_list';
...
PRINT '  Created: vw_tmi_slot_allocation';
...
PRINT '  Created: vw_tmi_demand_by_hour';
...
PRINT '  Created: vw_tmi_demand_by_quarter';
...
PRINT '  Created: vw_tmi_popup_pending';
...
PRINT '  Created: vw_tmi_program_metrics';

PRINT '';
PRINT 'GDT views v2 created successfully.';
PRINT '';
PRINT 'Next: Run 012_create_gdt_procedures_v2.sql';
GO
