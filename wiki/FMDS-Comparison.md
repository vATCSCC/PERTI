> **Styled version available at [perti.vatcscc.org/fmds-comparison](https://perti.vatcscc.org/fmds-comparison)**
...
| **F.2.5.4 Query Adaptation Data** (fPRD_2008) -- Playbook, CDR, NFDC queries | CDR search: `route_cdr` table, `assets/js/playbook-cdr-search.js`. Playbook routes: `route_playbook` table. Fix lookup: `api/data/fixes.php`. Demand analysis: `api/adl/demand/` (fix, airway, segment). FEA: `api/swim/v1/fea`. | **Full** | |
