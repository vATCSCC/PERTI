...
if ($include_recent) {
    ...
    SELECT
        ...
        p.airborne_flights, p.popup_flights,
        p.avg_delay_min, p.max_delay_min, p.total_delay_min,
        p.reserve_pct, p.compression_enabled,
        p.reopt_cycle, p.last_reopt_utc,
