...
| File | Line | Issue |
|------|------|-------|
| `scripts/migrate_division_events.php` | 26 | `'pass' => getenv('DB_PASS') ?: 'CAMRN@11000'` |
| `api/stats/config_stats.php` | 41 | `define('STATS_SQL_PASSWORD', env_stats('STATS_SQL_PASSWORD', 'CAMRN@11000'))` |
