...
//   'hibernated' => true = visually muted, page redirects to /hibernation
// ============================================================================
...
$nav_config = [
    ...
    'planning' => [
        ...
        'items' => [
            ...
            ['label' => __('nav.historicalRoutes'), 'path' => './historical-routes'],
            ['label' => __('nav.rad'), 'path' => './rad'],
    ...
    'admin' => [
        ...
        'items' => [
            ...
            ['label' => __('nav.sua'), 'path' => './sua', 'hibernated' => $_h],
        ]
    ],
    // Dropdown: SWIM API
    'swim' => [
