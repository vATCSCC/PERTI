...
```css
/* Summary cards with state badges */
.cdm-summary-card { padding: 16px; border-radius: 8px; }
.cdm-summary-value { font-size: 2rem; font-weight: 700; }
...
.cdm-compliance-compliant { color: #28a745; }
.cdm-compliance-at_risk { color: #fd7e14; }
.cdm-compliance-non_compliant { color: #dc3545; }
```

### Navdata Page

```css
/* Card with left-border change indicator */
.navdata-card {
    border-left: 4px solid transparent;
    transition: border-color 0.2s;
}
.navdata-card.changed { border-left-color: #007bff; }

/* Action type badges */
.badge-added { background: #28a745; }
.badge-moved { background: #17a2b8; }
.badge-changed { background: #fd7e14; }
.badge-superseded { background: #6c757d; }
...
```css
/* Map-first hero layout */
.pb-map-section { height: 55vh; position: relative; }
...
/* Ops level severity badges */
.ops-level-1 { background: #22c55e; }    /* Normal */
.ops-level-2 { background: #f59e0b; }    /* Elevated */
.ops-level-3 { background: #ef4444; }    /* Critical */

/* Section headers with color variants */
.section-header { background: #1e40af; color: white; padding: 8px 16px; }
.section-header.green { background: #166534; }
.section-header.slate { background: #334155; }

/* Status badges */
.status-atc-zero { background: #ef4444; }
.status-atc-alert { background: #f59e0b; }
.status-atc-limited { background: #3b82f6; }
```
...
### Route Analysis Panel (Shared)

```css
/* Dark collapsible panel (used by playbook + historical routes) */
...
| `assets/css/ctp.css` | CTP split-pane layout and controls |
| `assets/css/navdata.css` | Navdata cards, change badges |
| `assets/css/playbook.css` | Playbook map-first layout, catalog overlay |
| `assets/css/routes.css` | Historical routes 3-panel layout |
| `assets/css/route-analysis.css` | Route analysis dark panel (shared) |
| `assets/css/tmi-compliance.css` | TMI compliance indicators |
