-- ============================================================================
-- ADL Changelog System - Migration 003: Fix flight_status Reference
--
-- Fixes the trigger that still references the removed flight_status column
-- Updates it to use only the phase column
--
-- Run Order: Run immediately to fix error
-- ============================================================================
...
PRINT '=== ADL Changelog Migration 003: Fix flight_status Reference ===';
PRINT 'Started at: ' + CONVERT(VARCHAR, GETUTCDATE(), 120);
GO

-- ============================================================================
-- Recreate Trigger: tr_adl_flight_core_Changelog
-- (This replaces the old trigger that referenced flight_status)
-- ============================================================================
...
PRINT 'Recreated trigger dbo.tr_adl_flight_core_Changelog (removed flight_status references)';
GO
