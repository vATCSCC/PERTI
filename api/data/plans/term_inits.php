                    ...
                    foreach ($times as &$time) {
                        ...
                        if ($t_q['total'] > 0) {
                            if ($t_q['probability'] == 0) {
                                // CDW
                                if ($perm == true) {
                                    echo '<td style="width: 3%; background-color: #ffd501;" onclick="changeTermTime(`'.intval($t_q['id']).'`, `'.intval($t_q['probability']).'`)" data-toggle="tooltip" title="Critical Decision Window"></td>';
                                } else {
